  ...
  return (
    ...
    <Link href={'/dashboard'}>
      ...
      <div className="flex flex-col gap-3 my-4">
        ...
        <h2 className="font-bold">locationType *</h2>
        ...
        <div className="flex justify-evenly">
            {ThemeOptions.map((color,index)=>(
                <div key={index} className={`h-7 w-7 rounded-full ${themeColor==color &&
                'border border-4 border-black'}`} style={{backgroundColor:color}}
